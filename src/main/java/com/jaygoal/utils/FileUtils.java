...
public final class FileUtils {
     ...
     * @return 目录删除成功返回true, 否则返回false
     */
    public static boolean deleteDirUnder(String srcFile) {
     ...
     * @throws Exception
     */
    public static void copyFiles(String srcPathStr, String desPathStr) throws Exception {

        String newFileName = srcPathStr.substring(srcPathStr.lastIndexOf("/")+1); //源文件名称
